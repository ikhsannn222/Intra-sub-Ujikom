<div>
    <div class="breadcrumbs text-sm mt-4">
        <ul>
            ...
            <li><a href="{{ route('jabatan.index') }}" class="text-black-400 font-semibold">Jabatan</a></li>
        </ul>
    </div>
        ...
        @can('manageJabatan-create')
            ...
            <div class="relative w-1/2">
                ...
                <input type="text"
                    ...
                    wire:model.live="search" placeholder="Search Jabatan...">
            </div>
        @endcan
    </h2>
    ...
    <div class="w-full overflow-hidden rounded-lg shadow-xs">
                        ...
                        <tr class="text-gray-700 dark:text-gray-400">
                            ...
                            <td class="px-4 py-3">
                                <div class="flex items-center space-x-4 text-sm">
                                    ...
                                    @endcan
                                    @can('manageJabatan-delete')
                                        <button onclick="my_modal_{{ $jabatan->id }}.showModal()"
                                    ...
                                    @endcan
                                    <!-- Modal Konfirmasi -->
                                    <dialog id="my_modal_{{ $jabatan->id }}"
                                        ...
                                        <div
                                            ...
                                            <h3 class="text-lg font-bold">Apakah anda mau menghapus jabatan ini</h3>
        ...
        {{-- paginate --}}
        {{ $jabatans->links('livewire::tailwind') }}
