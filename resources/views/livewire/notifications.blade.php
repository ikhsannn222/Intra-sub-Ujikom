<div x-data="{
    ...
    <div class="space-y-3">
        @forelse ($notifications as $notification)
            <div
                ...
                class="flex items-center justify-between p-3 bg-gray-100 dark:bg-gray-700 border-l-4 border-blue-500 rounded-lg shadow-md hover:bg-gray-200 dark:hover:bg-gray-800 transition duration-300"
            >
                ...
                <svg
                    ...
                    class="h-8 w-8 text-blue-500 hover:text-green-500 cursor-pointer transition duration-300"
                    viewBox="0 0 24 24"
                    stroke-width="2"
                    stroke="currentColor"
                    fill="none"
    ...
    <div x-show="openHistory" class="fixed inset-0 flex items-center justify-center bg-gray-900 bg-opacity-50">
        <div class="bg-white dark:bg-gray-800 p-5 rounded-lg shadow-lg w-96 max-h-96 overflow-auto">
            <h3 class="text-lg font-semibold text-gray-800 dark:text-gray-200 mb-3">Histori Notifikasi</h3>
                ...
                >
                    <div>
                        ...
                        <p class="text-xs text-gray-500 font-semibold">
                            {{ $historyItem->read_at ? 'Sudah dibaca' : 'Belum dibaca' }}
                        </p>
                    </div>
