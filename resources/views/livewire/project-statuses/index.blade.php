<div>
    <div class="breadcrumbs text-sm mt-4">
        <ul>
            ...
            <li><a href="{{ route('project-statuses.index') }}" class="text-black-400 font-semibold">Project Status</a>
            </li>
        </ul>
    </div>
        ...
        @can('managePermission-create')
            ...
            <div class="relative w-1/2">
                ...
                <input type="text"
                    ...
                    wire:model.live="search" placeholder="Search Project Status...">
            </div>
        @endcan
    </h2>
                        ...
                        <tr class="text-gray-700 dark:text-gray-400">
                            ...
                            <td class="px-4 py-3">
                                <div class="flex items-center space-x-4 text-sm">
                                    @can('manageProjectStatuses-edit')
                                        <a href="{{ route('project-statuses.edit', $stats->id) }}"
                                    ...
                                    @endcan
                                    @can('manageProjectStatuses-view')
                                        <a href="{{ route('project-statuses.show', $stats->id) }}"
                                    ...
                                    @endcan
                                    @can('manageProjectStatuses-delete')
                                        <button onclick="my_modal_{{ $stats->id }}.showModal()"
