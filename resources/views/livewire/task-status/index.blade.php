<div>
    <div class="breadcrumbs text-sm mt-4">
        <ul>
            ...
            <li><a href="{{ route('task-status.index') }}" class="text-black-400 font-semibold">Task Status</a></li>
        </ul>
    </div>
    <h2 class="flex items-center space-x-4 my-6 text-2xl font-semibold text-gray-700 dark:text-black-200">
        <span>Task Status</span>
        @can('manageTaskStatus-create')
            ...
            <div class="relative w-1/2">
                ...
                <input type="text"
                    ...
                    wire:model.live="search" placeholder="Search Status...">
            </div>
        @endcan
    </h2>
    ...
    <div class="w-full overflow-hidden rounded-lg shadow-xs">
        ...
        {{-- paginate --}}
        {{ $taskStatus->links('livewire::tailwind') }}
    </div>
</div>
