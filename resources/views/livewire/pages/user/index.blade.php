                ...
                <tbody class="bg-white divide-y dark:divide-black-700 dark:bg-gray-800">
                    @foreach ($users as $user)
                        <tr class="text-gray-700 dark:text-gray-400">
                            ...
                            <td class="px-4 py-3 text-sm">{{ $user->nrp }}</td>
                            <td class="px-4 py-3 text-sm">{{ $user->is_active ? 'Aktif' : 'Tidak Aktif' }}</td>
                            <td class="px-4 py-3 text-sm">{{ $user->getRoleNames()->first() }}</td>
                            <td class="px-4 py-3">
                                <div class="flex items-center space-x-4 text-sm">
                                    ...
                                    @can('manageUser-delete')
                                        <button onclick="my_modal_{{ $user->id }}.showModal()"
                                    ...
                                    <dialog id="my_modal_{{ $user->id }}"
                                        ...
                                        <div
                                            ...
                                            <h3 class="text-lg font-bold">Apakah anda mau menghapus user ini</h3>
