<div class="container mx-auto">
    <div class="breadcrumbs text-sm mt-4">
        <ul>
            ...
            <li><a href="{{ route('role.index') }}" class="text-black-400 font-semibold">Role</a></li>
        </ul>
    </div>
        ...
        @can('manageRole-create')
            ...
            <div class="relative w-1/2">
                ...
                <input type="text"
                    ...
                    wire:model.live="search" placeholder="Search Role...">
            </div>
        @endcan
    </h2>
                                ...
                                @else
                                    <div class="flex flex-wrap gap-1">
                                        @foreach ($role->permissions as $permission)
                                            <span
                                                class="badge text-white bg-primary px-2 py-1 rounded">{{ $permission->name }}</span>
                                        @endforeach
                                    </div>
                                @endif
                            </td>
                            <td class="px-4 py-3">
                                <div class="flex items-center justify-center space-x-4 text-sm">
                                    ...
                                    @can('manageRole-delete')
                                        <button onclick="my_modal_{{ $role->id }}.showModal()"
                                    ...
                                    <dialog id="my_modal_{{ $role->id }}"
                                        ...
                                        <div
                                            ...
                                            <h3 class="text-lg font-bold">Apakah anda mau menghapus role ini?</h3>
                                            <div class="modal-action">
                                                ...
                                                <button class="btn hover:bg-gray-900 dark:bg-gray-700 dark:text-white"
                                                    onclick="my_modal_{{ $role->id }}.close()">
                                                    Cancel
                                                </button>
                                            </div>
                                        </div>
