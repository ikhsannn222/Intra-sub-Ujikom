<div>
    ...
    <div class="w-full overflow-hidden rounded-lg shadow-xs">
                ...
                <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                    @foreach ($prioritas as $prioriti)
                        <tr class="text-gray-700 dark:text-gray-400">
                            ...
                            <td class="px-4 py-3 text-sm">
                                <span style="background-color: {{ $prioriti->color }};"
                                    class="rounded-sm px-2 py-1 text-white"
                                    style="font-size: 0.8rem;">{{ $prioriti->color }}</span>
                            </td>
                            <td class="px-4 py-3 text-sm">
                                @if ($prioriti->is_default == 1)
                            ...
                            <td class="px-4 py-3">
                                <div class="flex items-center space-x-4 text-sm">
                                    @can('manageTaskPriorities-edit')
                                        <a href="{{ route('priorities.edit', $prioriti->id) }}"
                                    ...
                                    @endcan
                                    @can('manageTaskPriorities-view')
                                        <a href="{{ route('priorities.show', $prioriti->id) }}"
                                    ...
                                    @endcan
                                    @can('manageTaskPriorities-delete')
                                        <button onclick="my_modal_{{ $prioriti->id }}.showModal()"
                                    ...
                                    <dialog id="my_modal_{{ $prioriti->id }}"
                                        ...
                                        <div
                                            ...
                                            <h3 class="text-lg font-bold">Apakah anda mau menghapus priority ini</h3>
        ...
        {{-- pagination --}}
        {{ $prioritas->links('livewire::tailwind') }}
